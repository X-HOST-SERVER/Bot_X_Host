...
global.dfail = (type, m, conn, usedPrefix) => {
    const mensajes = {
        rowner: '「🔥」الامـࢪ دا بـتـا؏ بــودي  مـطـوࢪي.',
  owner:  '「💥」 الامـࢪ دا بـتـا؏ بــودي مـطـوࢪي.',
  ...
  unreg: '「🔥」 سـجـل الاول يـسـطـا لـتـسـجـيـل اڪـتـب.تسجيل الاسم.العمر  مثال/.تسجيل بودي.18       لازم عشان تستعمل الامࢪ لازم تسجل',
